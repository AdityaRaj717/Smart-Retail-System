...
# This would be generated by your create_database.py script
# For now, we'll keep the manual dictionary for demonstration
product_db = {
...
try:
    # You would save your embedding model with a new name
